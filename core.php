...
<head>
    ...
    <title>Seven360 Security Panel</title>
...
?>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<center><a href="dashboard.php" class="brand-link">
      <span class="brand-text font-weight-light"><i class="fab fa-get-pocket"></i> Seven360 Panel</span>
    </a></center>
...
<footer class="main-footer">
    ...
    <strong>&copy; <?php
    echo date("Y");
?> Seven360 Security Panel</strong>
