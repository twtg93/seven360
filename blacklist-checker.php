...
if (!empty($_POST['ip'])) {
    ...
    if (!filter_var($ip, FILTER_VALIDATE_IP)) {
        ...
        echo '<div class="card card-primary card-outline">
			<div class="card-header">
				<h3 class="card-title"><i class="fas fa-th-list"></i> Results for <b>' . $_POST['ip'] . '</b></h3>
			</div>
			<div class="card-body">';
    ...
    <tbody>';
        ...
        echo "Thе IP Address is listed in <b>" . $BadCount . " blacklists</b> of <b>" . $AllCount . " total</b><br/>";
