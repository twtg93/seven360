...
<div class="content-wrapper">
			...
			<div class="content-header">
				...
				<div class="container-fluid">
				  <div class="row mb-2">
        		    <div class="col-sm-6">
        		      <h1 class="m-0 "><i class="fas fa-globe"></i> Country Bans</h1>
        		    </div>
        		    <div class="col-sm-6">
...
while ($rowbc = $querybc->fetch_assoc()) {
    ...
    echo '</td>
											...
											<td>
                                            <a href="?edit-id=' . $rowbc['id'] . '" class="btn btn-flat btn-primary btn-sm"><i class="fas fa-edit"></i> Edit</a>
                                            <a href="?delete-id=' . $rowbc['id'] . '" class="btn btn-flat btn-success btn-sm"><i class="fas fa-trash"></i> Delete</a>
											</td>
										</tr>
';
}
	...
	<select name="redirect" class="form-control" required>
        ...
        <option value="1">Yes</option>
                        ...
                        <div class="card-footer">
							<button class="btn btn-flat btn-danger btn-block" name="add-country" type="submit">Add</button>
				        </div>
				     </div>
</form>
				</div>
