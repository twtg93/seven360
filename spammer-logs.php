...
if (isset($_GET['delete-all'])) {
    $table = $prefix . 'logs';
    $query = $mysqli->query("DELETE FROM `$table` WHERE type='Spammer'");
}
?>
<div class="content-wrapper">
			...
			<div class="content-header">
				...
				<div class="container-fluid">
				  <div class="row mb-2">
        		    <div class="col-sm-6">
        		      <h1 class="m-0 "><i class="fas fa-align-justify"></i> Spammer Logs</h1>
        		    </div>
        		    <div class="col-sm-6">
				...
				<div class="col-md-12">
				    ...
				    <div class="card card-primary card-outline">
						<div class="card-header">
						    ...
						    <a href="?delete-all" class="btn btn-flat btn-danger btn-sm float-sm-right" data-toggle="tooltip" title="Delete all Spammer logs"><i class="fas fa-trash"></i> Delete All</a>
						</div>
						<div class="card-body">
...
<?php
$table = $prefix . 'logs';
$sql   = $mysqli->query("SELECT id, ip, date, time, browser, browser_code, os, os_code, country, country_code, type FROM `$table` WHERE type='Spammer' ORDER by id DESC");
