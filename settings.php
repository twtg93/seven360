...
if (isset($_POST['save'])) {
    ...
    $query = $mysqli->query("UPDATE `$table` SET email='$email', project_security='$project_security', mail_notifications='$mail_notifications', ip_detection='$ip_detection', dark_mode='$dark_mode' WHERE id=1");
...
?>" required>
                                            ...
                                            <div class="form-group">
												<label class="control-label">Seven360</label><br />
