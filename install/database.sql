...
INSERT INTO `<DB_PREFIX>settings` (`id`, `email`, `username`, `password`, `project_security`, `mail_notifications`, `ip_detection`, `dark_mode`, `countryban_blacklist`, `live_traffic`, `badword_replace`, `error_reporting`, `display_errors`) VALUES
(1, 'admin@mail.com', 'admin', '', 1, 1, 0, 0, 1, 0, '[Censored]', 5, 0);
