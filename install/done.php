...
<div class="alert alert-success">
	Seven360 has been successfully installed on your website!
</div>
...
<b>Put the integration code in a main <i>.php</i> file of your website to integrate it with Seven360.</b><br />
...
<br /><br />
	<kbd>
	    ...
	    include_once "seven360.php";
	</kbd>
</div>
    
<a href="../" class="btn-success btn btn-block"><i class="fas fa-arrow-circle-right"></i> Continue to Seven360</a>
</center>
<?php
footer();
?>